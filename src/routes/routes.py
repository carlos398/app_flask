...
routes = {
    ...
    "update_controller": UpdateProductController.as_view('update'),

    "categories_route": '/create/categories/', 
    "categories_controller": CreateCategoriesController.as_view('create_categories'),
